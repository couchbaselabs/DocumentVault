...
struct GroceryAppApp: App {
        ...
        for address in broadcastAddresses {
            ...
            connection.stateUpdateHandler = { state in
                ...
                case .ready:
                    ...
                    connection.send(content: "GroceryApp-Permission-Test".data(using: .utf8), completion: .contentProcessed({ _ in
                        connection.cancel()
                    }))
    ...
    private func triggerWithBonjourService_DEPRECATED() {
        ...
        do {
            ...
            listener.service = NWListener.Service(name: "GroceryApp-\(UUID().uuidString.prefix(8))", type: "_groceryapp._tcp")
