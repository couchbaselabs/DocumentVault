...
final class GroceryAppUITests: XCTestCase {
    ...
    override func setUpWithError() throws {
        ...
        // TODO: In UI tests it is usually best to stop immediately when a failure occurs.
        continueAfterFailure = false

        // TODO: In UI tests it’s important to set the initial state - such as interface orientation - required for your tests before they run. The setUp method is a good place to do this.
    }
